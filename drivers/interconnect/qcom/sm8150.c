...
static struct qcom_icc_node qnm_snoc = {
	...
	.links = { SLAVE_A1NOC_CFG, SLAVE_A2NOC_CFG,
		   ...
		   SLAVE_EMAC_CFG, SLAVE_GLM,
		   SLAVE_GFX3D_CFG, SLAVE_IMEM_CFG,
		   SLAVE_IPA_CFG, SLAVE_CNOC_MNOC_CFG,
		   SLAVE_NPU_CFG, SLAVE_PCIE_0_CFG,
		   SLAVE_PCIE_1_CFG, SLAVE_NORTH_PHY_CFG,
		   SLAVE_PIMEM_CFG, SLAVE_PRNG,
		   SLAVE_QDSS_CFG, SLAVE_QSPI,
		   SLAVE_QUP_2, SLAVE_QUP_1,
		   SLAVE_QUP_0, SLAVE_SDCC_2,
		   SLAVE_SDCC_4, SLAVE_SNOC_CFG,
		   SLAVE_SPDM_WRAPPER, SLAVE_SPSS_CFG,
		   SLAVE_SSC_CFG, SLAVE_TCSR,
		   SLAVE_TLMM_EAST, SLAVE_TLMM_NORTH,
...
static struct qcom_icc_qosbox acm_apps_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 4,
	.offsets = { 0x2e000, 0x2e080, 0x2e100, 0x2e180 },
	.config = &(struct qos_config) {
		.prio = 0,
		.urg_fwd = 1,
	},
...
static struct qcom_icc_bcm bcm_cn0 = {
	...
	.nodes = { &qhm_spdm, &qnm_snoc,
		   ...
		   &qhs_pcie1_cfg, &qhs_phy_refgen_north,
		   &qhs_pimem_cfg, &qhs_prng,
		   &qhs_qdss_cfg, &qhs_qspi,
		   &qhs_qupv3_east, &qhs_qupv3_north,
		   &qhs_qupv3_south, &qhs_sdc2,
		   &qhs_sdc4, &qhs_snoc_cfg,
		   &qhs_spdm, &qhs_spss_cfg,
		   &qhs_ssc_cfg, &qhs_tcsr,
		   &qhs_tlmm_east, &qhs_tlmm_north,
		   &qhs_tlmm_south, &qhs_tlmm_west,
		   &qhs_tsif, &qhs_ufs_card_cfg,
...
static struct qcom_icc_bcm bcm_sn3 = {
	...
	.voter_idx = 0,
	.num_nodes = 3,
	.nodes = { &srvc_aggre1_noc, &srvc_aggre2_noc,
		   &qns_cnoc },
};
