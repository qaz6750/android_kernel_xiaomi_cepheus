...
/* USB */
#define PSY_IIO_PD_ALLOWED			0x89
#define PSY_IIO_BOOST_CURRENT			0x8a
#define PSY_IIO_SDP_CURRENT_MAX			0x8b
#define PSY_IIO_STEP_CHARGING_ENABLED		0x8c

/* BATTERY */
#define PSY_IIO_CHARGE_QNOVO_ENABLE		0x8d

/* FG GEN3 */
#define PSY_IIO_COLD_TEMP			0x8e
#define PSY_IIO_COOL_TEMP			0x8f
#define PSY_IIO_WARM_TEMP			0x90
#define PSY_IIO_FG_RESET_CLOCK			0x92

/* BQ2597X CHARGER */
#define PSY_IIO_BQ_BATTERY_PRESENT		0x91
#define PSY_IIO_BQ_VBUS_PRESENT	0x93
#define PSY_IIO_BQ_BATTERY_VOLTAGE	0x94
#define PSY_IIO_BQ_BATTERY_CURRENT			0x95
#define PSY_IIO_BQ_BATTERY_TEMPERATURE			0x96
#define PSY_IIO_BQ_BUS_VOLTAGE			0x97
#define PSY_IIO_BQ_BUS_CURRENT		0x98
#define PSY_IIO_BQ_BUS_TEMPERATURE		0x99
#define PSY_IIO_BQ_DIE_TEMPERATURE			0x100
#define PSY_IIO_BQ_ALARM_STATUS		0x9a
#define PSY_IIO_BQ_FAULT_STATUS		0x9b
#define PSY_IIO_BQ_REG_STATUS	0x9c
#define PSY_IIO_BQ_SET_BUS_PROTECTION_FOR_QC3	0x9d
#define PSY_IIO_BQ_BUS_ERROR_STATUS		0x9e
#define PSY_IIO_BQ_CHARGING_ENABLED	0x9f

/* unused 0xa0 0xa1 */
/* Xiaomi FG GEN4 */
#define PSY_IIO_SHUTDOWN_DELAY      0xa2
#define PSY_IIO_SOC_DECIMAL         0xa3
#define PSY_IIO_SOC_DECIMAL_RATE    0xa4
#define PSY_IIO_COLD_THERMAL_LEVEL  0xa5
#define PSY_IIO_FASTCHARGE_MODE     0xa6
#define PSY_IIO_FFC_TERMINATION_CURRENT     0xa7
#define PSY_IIO_SYS_TERMINATION_CURRENT     0xa8
#define PSY_IIO_FFC_SYS_TERMINATION_CURRENT 0xa9
#define PSY_IIO_VBATT_FULL_VOL              0xb1
#define PSY_IIO_FFC_VBATT_FULL_VOL          0xb2
#define PSY_IIO_KI_COEFF_CURRENT            0xb3
#define PSY_IIO_SHUTDOWN_DELAY_ENABLE       0xb4

/* Xiaomi SMB5 */
#define PSY_IIO_PD_AUTHENTICATION 0xb5
#define PSY_IIO_BQ_FASTCHARGE_MODE 0xb6
#define PSY_IIO_PD_REMOVE_COMPENSATION 0xb7
#define PSY_IIO_HVDCP3_TYPE 0xb8
#define PSY_IIO_TYPE_RECHECK 0xb9
#define PSY_IIO_APDO_MAX 0xc0
#define PSY_IIO_LIQUID_DETECTION 0xc1
#define PSY_IIO_DYNAMIC_FV_ENABLED 0xc2
#define PSY_IIO_BATTERY_CHARGING_ENABLED 0xc3
#define PSY_IIO_DC_THERMAL_LEVELS 0xc4
#define PSY_IIO_DP_DM_BQ 0xc5
#define PSY_IIO_BATTERY_CHARGING_LIMITED 0xc6
#define PSY_IIO_SLOWLY_CHARGING 0xc7
#define PSY_IIO_BQ_INPUT_SUSPEND 0xc8
