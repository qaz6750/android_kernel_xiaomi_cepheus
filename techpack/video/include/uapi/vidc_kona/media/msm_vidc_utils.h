...
enum v4l2_mpeg_video_hevc_level_kona {
	V4L2_MPEG_VIDEO_HEVC_LEVEL_UNKNOWN =
		V4L2_MPEG_VIDEO_HEVC_LEVEL_6_2	+ 1,
};

enum v4l2_mpeg_video_h264_level_kona {
...
#define V4L2_CID_MPEG_VIDC_VIDEO_STREAM_OUTPUT_MODE_LEGACY \
...
enum v4l2_mpeg_vidc_video_hevc_profile {
...
enum v4l2_mpeg_vidc_video_hevc_level {
