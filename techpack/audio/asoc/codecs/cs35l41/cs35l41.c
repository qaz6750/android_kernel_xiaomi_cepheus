...
static int cs35l41_set_dai_fmt(struct snd_soc_dai *codec_dai, unsigned int fmt)
{
	struct cs35l41_private *cs35l41 =
			snd_soc_codec_get_drvdata(codec_dai->component);
...
{
	struct cs35l41_private *cs35l41 =
		snd_soc_codec_get_drvdata(dai->component);
	int i;
...
static void cs35l41_codec_remove(struct snd_soc_codec *codec)
{
	struct cs35l41_private *cs35l41 = snd_soc_codec_get_drvdata(codec);
...
static struct snd_soc_component_driver soc_codec_dev_cs35l41 = {
