...
static struct snd_soc_dai_link msm_common_dai_links[] = {
	...
	/* Hostless PCM purpose */
	{
		...
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(slimbus_0_hostless),
	},
	{
		.name = "MSM AFE-PCM RX",
	...
	},
	{
		...
		.ignore_suspend = 1,
		 /* this dailink has playback support */
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(slimbus_1_hostless),
	},
	{
		...
		.ignore_suspend = 1,
		 /* this dailink has playback support */
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(slimbus_3_hostless),
	},
	{
		...
		.ignore_suspend = 1,
		 /* this dailink has playback support */
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(slimbus_4_hostless),
	},
	{
...
static struct snd_soc_dai_link msm_tavil_fe_dai_links[] = {
	...
	/* Ultrasound RX DAI Link */
	{
		...
		SND_SOC_DAILINK_REG(slimbus_2_hostless),
	},
	/* Ultrasound TX DAI Link */
	{
		...
		.no_host_mode = SND_SOC_DAI_LINK_NO_HOST,
		.ops = &msm_slimbus_2_be_ops,
		SND_SOC_DAILINK_REG(slimbus_2_hostless_cap),
	},
};
...
static struct snd_soc_dai_link msm_common_misc_fe_dai_links[] = {
	...
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(quat_mi2s_rx_hostless_pb),
	},
	{
	...
	/* Voice Stub */
	{
		...
		/* this dainlink has playback support */
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(voice_stub),
	},
};
...
static struct snd_soc_dai_link msm_common_be_dai_links[] = {
	...
	/* Proxy Tx BACK END DAI Link */
	{
		...
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_proxy_tx),
	},
	/* Proxy Rx BACK END DAI Link */
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_proxy_rx),
	},
	{
...
static struct snd_soc_dai_link msm_tavil_be_dai_links[] = {
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_be_ops,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_0_rx),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_be_ops,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_0_tx),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_1_rx),
	},
	{
		...
		.ops = &msm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_1_tx),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_2_rx),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_3_rx),
	},
	{
		...
		.ops = &msm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_3_tx),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_4_rx),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_5_rx),
	},
	/* MAD BE */
	{
		...
		.ops = &msm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_5_tx),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_6_rx),
	},
	/* Slimbus VI Recording */
	{
		...
		.no_pcm = 1,
		.dpcm_capture = 1,
		SND_SOC_DAILINK_REG(lpass_be_slimbus_tx_vi),
	},
};
...
static int sm8150_ssr_enable(struct device *dev, void *data)
{
	...
	if ((!strcmp(card->name, "sm8150-tavil-snd-card")) ||
			(!strcmp(card->name, "sm8150-hana55-snd-card"))) {
		pdata = snd_soc_card_get_drvdata(card);
...
static void sm8150_ssr_disable(struct device *dev, void *data)
{
	struct platform_device *pdev = to_platform_device(dev);
	struct snd_soc_card *card = platform_get_drvdata(pdev);
	struct msm_asoc_mach_data *pdata;
...
static const struct snd_event_ops sm8150_ssr_ops = {
	.enable = sm8150_ssr_enable,
	.disable = sm8150_ssr_disable,
};
...
static int msm_audio_ssr_register(struct device *dev)
{
	...
	ret = snd_event_master_register(dev, &sm8150_ssr_ops,
					ssr_clients, NULL);
	if (!ret)
